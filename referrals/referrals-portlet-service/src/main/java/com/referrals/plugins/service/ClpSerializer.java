...
import com.referrals.plugins.model.FooClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "referrals-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "referrals-portlet";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals("com.referrals.plugins.model.impl.FooImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals("com.referrals.plugins.NoSuchFooException")) {
            return new com.referrals.plugins.NoSuchFooException();
        }
