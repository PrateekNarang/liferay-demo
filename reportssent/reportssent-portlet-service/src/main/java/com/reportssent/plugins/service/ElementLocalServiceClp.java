 ...
 * @generated
 */
public class ElementLocalServiceClp implements ElementLocalService {
    ...
    public ElementLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public com.reportssent.plugins.model.Element addElement(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(element) });
        } catch (Throwable t) {
        ...
        return (com.reportssent.plugins.model.Element) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.reportssent.plugins.model.Element getElement(long statusId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName13,
                    _methodParameterTypes13, new Object[] { statusId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.reportssent.plugins.model.Element> getElements(
        ...
        return (java.util.List<com.reportssent.plugins.model.Element>) ClpSerializer.translateOutput(returnObj);
    }
