...
public class PatientsLocalServiceClpInvoker {
    ...
    public PatientsLocalServiceClpInvoker() {
        ...
        _methodName11 = "fetchPatientsByUuidAndCompanyId";

        _methodParameterTypes11 = new String[] { "java.lang.String", "long" };

        _methodName12 = "fetchPatientsByUuidAndGroupId";
        ...
        _methodName15 = "getPatientsByUuidAndCompanyId";

        _methodParameterTypes15 = new String[] { "java.lang.String", "long" };

        _methodName16 = "getPatientsByUuidAndGroupId";

        _methodParameterTypes16 = new String[] { "java.lang.String", "long" };

        _methodName17 = "getPatientses";

        _methodParameterTypes17 = new String[] { "int", "int" };

        _methodName18 = "getPatientsesCount";

        _methodParameterTypes18 = new String[] {  };

        _methodName19 = "updatePatients";
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return PatientsLocalServiceUtil.addPatients((com.statuspatients.plugins.model.Patients) arguments[0]);
        }
        ...
        if (_methodName3.equals(name) &&
            ...
            return PatientsLocalServiceUtil.deletePatients((com.statuspatients.plugins.model.Patients) arguments[0]);
        }
        ...
        if (_methodName11.equals(name) &&
            ...
            return PatientsLocalServiceUtil.fetchPatientsByUuidAndCompanyId((java.lang.String) arguments[0],
                ((Long) arguments[1]).longValue());
        }

        if (_methodName12.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes12, parameterTypes)) {
            return PatientsLocalServiceUtil.fetchPatientsByUuidAndGroupId((java.lang.String) arguments[0],
                ((Long) arguments[1]).longValue());
        }
        ...
        if (_methodName15.equals(name) &&
            ...
            return PatientsLocalServiceUtil.getPatientsByUuidAndCompanyId((java.lang.String) arguments[0],
                ((Long) arguments[1]).longValue());
        }

        if (_methodName16.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes16, parameterTypes)) {
            return PatientsLocalServiceUtil.getPatientsByUuidAndGroupId((java.lang.String) arguments[0],
                ((Long) arguments[1]).longValue());
        }
        ...
        if (_methodName19.equals(name) &&
            ...
            return PatientsLocalServiceUtil.updatePatients((com.statuspatients.plugins.model.Patients) arguments[0]);
        }
