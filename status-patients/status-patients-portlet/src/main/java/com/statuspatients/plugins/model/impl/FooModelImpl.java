...
import com.statuspatients.plugins.model.FooModel;
import com.statuspatients.plugins.model.FooSoap;
...
/**
 * The base model implementation for the Foo service. Represents a row in the &quot;OH_Foo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.statuspatients.plugins.model.FooModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link FooImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see FooImpl
 * @see com.statuspatients.plugins.model.Foo
 * @see com.statuspatients.plugins.model.FooModel
 * @generated
 */
@JSON(strict = true)
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a foo model instance should use the {@link com.statuspatients.plugins.model.Foo} interface instead.
     */
    public static final String TABLE_NAME = "OH_Foo";
    ...
    public static final String TABLE_SQL_CREATE = "create table OH_Foo (uuid_ VARCHAR(75) null,fooId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,field1 VARCHAR(75) null,field2 BOOLEAN,field3 INTEGER,field4 DATE null,field5 VARCHAR(75) null)";
    public static final String TABLE_SQL_DROP = "drop table OH_Foo";
    public static final String ORDER_BY_JPQL = " ORDER BY foo.field1 ASC";
    public static final String ORDER_BY_SQL = " ORDER BY OH_Foo.field1 ASC";
    public static final String DATA_SOURCE = "liferayDataSource";
    public static final String SESSION_FACTORY = "liferaySessionFactory";
    public static final String TX_MANAGER = "liferayTransactionManager";
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.com.statuspatients.plugins.model.Foo"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.com.statuspatients.plugins.model.Foo"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.com.statuspatients.plugins.model.Foo"),
            true);
    ...
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
                "lock.expiration.time.com.statuspatients.plugins.model.Foo"));
