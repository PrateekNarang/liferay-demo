...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
    ...
    */
    ...
    @Override
    public int compareTo(com.statuspatients.plugins.model.Foo foo) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.statuspatients.plugins.model.Foo> toCacheModel() {
        return _foo.toCacheModel();
    }

    @Override
    public com.statuspatients.plugins.model.Foo toEscapedModel() {
        return new FooWrapper(_foo.toEscapedModel());
    }

    @Override
    public com.statuspatients.plugins.model.Foo toUnescapedModel() {
