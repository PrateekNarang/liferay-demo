...
<!--<aui:button-row>
	<portlet:renderURL var="viewPatientDetailURL">
		<portlet:param name="mvcPath" value="/patientDetail.jsp"></portlet:param>
	</portlet:renderURL>
	...
	<div class="row-fluid">
		...
		<div class="span12 ocuhub_detail_tile"
			...
			<div class="container-fluid occuhub_remove_padding">
				...
				<div class="row-fluid ocuhub_appointments_row ocuhub_row_1"
					onclick="document.getElementById('detail-url').click();">
